...
public class Tigrulya extends Character {
    public Tigrulya(String name, int cookiesCount, int eatSpeed) throws CookiesEatingException {
        super(name);
    ...
    public String makeSound(Character targetCharacter) {
        ...
        String[] sounds = { 
            "Мы найдем тебя, " + targetName, 
            targetName + ", ты куда пропал?", 
            "хватит прятаться " + targetName 
        };
